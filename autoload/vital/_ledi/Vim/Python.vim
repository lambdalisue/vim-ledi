...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_ledi#Vim#Python#import() abort
    return map({'eval_expr': '', 'is_python2_enabled': '', 'is_python3_enabled': '', 'exec_file': '', 'set_major_version': '', 'is_enabled': '', 'get_major_version': '', 'exec_code': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_ledi#Vim#Python#import() abort', printf("return map({'eval_expr': '', 'is_python2_enabled': '', 'is_python3_enabled': '', 'exec_file': '', 'set_major_version': '', 'is_enabled': '', 'get_major_version': '', 'exec_code': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
